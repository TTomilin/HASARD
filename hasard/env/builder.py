...
from safety_doom.utils.config import Sequence, sequence_scenarios, sequence_tasks, scenario_config, Scenario, \
    default_wrapper_config
from safety_doom.wrappers.observation import Augment, Resize, Rescale, RGBStack
...
def make_sequence(sequence: Sequence,
                  ...
                  task_idx: int = None) -> List[SafetyDoomEnv]:
    """
    ...
    Returns:
        List[SafetyDoomEnv]: A list of Doom environment instances.
    """
...
def make_envs(scenarios: List[Scenario],
              ...
              scenarios_kwargs: List[Dict[str, any]] = None,
              doom_kwargs: Dict[str, any] = None,
              wrapper_config: Dict[str, any] = None) -> List[SafetyDoomEnv]:
...
def make_env(scenario: Scenario,
             ...
             doom_kwargs: Dict[str, any] = None,
             wrapper_config: Dict[str, any] = None) -> SafetyDoomEnv:
    """
    ...
    Returns:
        SafetyDoomEnv: An instance of the Doom environment.
    """
...
def wrap_env(env: SafetyDoomEnv, wrap_conf: Dict[str, any]):
    """
    Applies a series of wrappers to the Doom environment based on the provided configuration.

    Args:
        env (SafetyDoomEnv): The Doom environment to be wrapped.
