...
from safety_doom.utils.utils import distance_traversed
from safety_doom.wrappers.reward import WrapperHolder, ConstantRewardWrapper, GameVariableRewardWrapper


class HealthGathering(SafetyDoomEnv):
    """
