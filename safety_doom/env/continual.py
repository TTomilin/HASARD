...
from safety_doom.env.builder import make_sequence
from safety_doom.env.scenario import SafetyDoomEnv
from safety_doom.utils.config import Sequence
...
class ContinualLearningEnv(BaseEnv):
    ...
    Attributes:
        ...
        envs (List[SafetyDoomEnv]): A list of Doom environment instances created based on the specified sequence.
    ...
    def get_active_env(self) -> SafetyDoomEnv:
